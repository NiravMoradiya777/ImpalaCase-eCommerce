<%@ Page Title="" Language="C#" MasterPageFile="~/ImpalaMaster.Master" AutoEventWireup="true" CodeBehind="EditCase.aspx.cs" Inherits="ImpalaCase_eCommerce.EditCase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainBody" runat="server">
    ...
    <div class="form-group">
        <label for="txtMaterial">Status</label>
        <asp:DropDownList ID="ddlStatus" CssClass="form-control" runat="server">
            <asp:ListItem Text="Active" Value="True"></asp:ListItem>
            <asp:ListItem Text="Inactive" Value="False"></asp:ListItem>
        </asp:DropDownList>
        <asp:RequiredFieldValidator ID="rfvStatus" runat="server" ControlToValidate="ddlStatus"
            InitialValue="" ErrorMessage="Status is required" Display="Dynamic" CssClass="text-danger"></asp:RequiredFieldValidator>
    </div>
    <div class="form-group">
        <asp:Button ID="btnUpdateCase" runat="server" Text="Update Case" CssClass="btn btn-primary" OnClick="btnUpdateCase_Click" />
    </div>
</asp:Content>
